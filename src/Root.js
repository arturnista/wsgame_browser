...
class Root extends Component {
    ...
    componentDidMount() {
        ...
        .add('move_indicator_00.png', '/img/game/move_indicator_00.png')
        .add('move_indicator_01.png', '/img/game/move_indicator_01.png')
        .add('move_indicator_02.png', '/img/game/move_indicator_02.png')
        .add('move_indicator_03.png', '/img/game/move_indicator_03.png')
        .add('spell_indicator_00.png', '/img/game/spell_indicator_00.png')
        .add('spell_indicator_01.png', '/img/game/spell_indicator_01.png')
        .add('spell_indicator_02.png', '/img/game/spell_indicator_02.png')
        .add('spell_indicator_03.png', '/img/game/spell_indicator_03.png')
