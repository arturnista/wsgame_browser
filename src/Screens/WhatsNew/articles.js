...
first.content += "I'm using way more process power than I need.  \n"
first.content += "All the requests are handled from a single process thread.  \n"
...
first.content += "  \n"
first.content += "## Features on be done on the future  \n"
...
first.content += "But for now, it's fine.  \n"
first.content += "  \n"
first.content += "### AAA stuff  \n"
first.content += "Users profile, ranks, matchmaking, emojis, ingame chat. All this stuff is pretty neat to do, but As mentioned before, I'm not going to work on it for now.  \n"
